...
该插件是一个 NoneBot2 跑团约车助手插件，提供桌游群招募、发车、封车等功能。
...
|    指令   |      权限     | 需要@ |   范围  |        说明       |
| :-----: | :---------: | :-: | :---: | :-------------: |
|   发车   |      用户     |  否  | 私聊/群聊 |   发布一条新的跑团招募信息  |
|   封车   |      用户     |  否  | 私聊/群聊 |    关闭自己的跑团招募    |
|   查车   |      用户     |  否  |   群聊  | 查看当前正在公开的跑团招募信息 |
| 开启全群广播 | 超级用户/群主/管理员 |  否  |   群聊  |     开启跑团招募广播    |
| 关闭全群广播 | 超级用户/群主/管理员 |  否  |   群聊  |     关闭跑团招募广播    |
|  强制封车  |     超级用户    |  否  |   群聊  |    强制关闭一条跑团招募   |
